...
# ===== CONFIG =====
st.set_page_config(page_title="🔥 Day Trading Scanner - TOP 20", layout="wide")

PRICE_MIN = 2
PRICE_MAX = 20
FLOAT_MAX = 20_000_000
REFRESH_SECONDS = 10
TOP_N = 20  # Number of symbols to show
DEFAULT_SYMBOLS = [
